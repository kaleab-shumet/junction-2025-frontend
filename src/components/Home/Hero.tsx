  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center z-20 flex-col">
      ...
      <h2 className="project-body-text p-res-lr p-res-tb text-center w-3/4 font-base">
        Stay connected from purchase to delivery. Amio connect keeps drivers and
        customers aligned at every step, ensuring both sides know exactly what’s
        happening the moment it matters.
      </h2>
