...
export default function AlternativeSelection() {
  ...
  const handleSendChoice = async () => {
    ...
    navigate(
      `/customer/confirmation/${orderId}?action=replace&itemId=${itemId}&replacementId=${selectedAlternative}`
    );
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-red-600 text-sm">
                  Original price: ${originalItem.originalPrice.toFixed(2)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-zinc-200 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-lg">
                No alternatives found matching your search
              </p>
